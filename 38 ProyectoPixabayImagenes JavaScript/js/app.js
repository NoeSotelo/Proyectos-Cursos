...
function validacion(e) {
    ...
    if(terminoBusqueda === ''){
        mostrarAlert('Agrega un termino de busqueda');
        return;
    }
...
function buscarImagenes() {
    ...
    const key = '31047437-a53f4fc10aa789d3d5323bd57';
...
function mostrarImg(imagenes) {
    ...
    imagenes.forEach(img => {
        const {likes, previewURL, views, largeImageURL} = img; 
        result.innerHTML += `
        <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
            <div class="bg-white">
                ...
                <div class="p-4">
                    <p class="font-bold">${likes} <span class="font-light"> Likes</p>
                    <p class="font-bold">${views} <span class="font-light"> Vistas</p>
                    <a 
